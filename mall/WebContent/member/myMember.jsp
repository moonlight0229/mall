...
<html>
	...
	<body>
		...
		<div class="container">
		 	<h1 class="display-4 mt-3 mb-3">주문내역</h1>
		 	
		 	<div class="d-flex justify-content-end">
			 	<a class="btn btn-danger mb-3" href='<%=request.getContextPath()%>/member/deleteMember.jsp?memberEmail=<%=session.getAttribute("loginMemberEmail")%>'>
			 		회원탈퇴
			 	</a>
		 	</div>
